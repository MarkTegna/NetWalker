"""Purge all AOS-10 platform devices and their connections from the database."""
import pyodbc
import base64
...
cursor.execute("SELECT device_id, device_name FROM devices WHERE platform = 'SG300'")
devices = cursor.fetchall()
print(f"Found {len(devices)} AOS-10 devices to purge")
