"""Purge all axis-* devices and their connections from the database."""
import pyodbc
import base64
...
cursor.execute("SELECT device_id, device_name FROM devices WHERE device_name LIKE 'axis-%'")
devices = cursor.fetchall()
print(f"Found {len(devices)} devices matching axis-*:")
for d in devices:
