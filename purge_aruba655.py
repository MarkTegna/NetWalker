"""Purge all Aruba 655 hardware devices and their connections from the database."""
import pyodbc
import base64
...
cursor.execute("SELECT device_id, device_name FROM devices WHERE hardware_model = 'Aruba 655'")
devices = cursor.fetchall()
print(f"Found {len(devices)} Aruba 655 devices")
