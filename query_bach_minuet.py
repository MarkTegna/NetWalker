"""
Query BACH_MINUET Device Information
"""

import pyodbc
from netwalker.config.config_manager import ConfigurationManager

def query_bach_minuet():
    """Query database for BACH_MINUET device information"""
    ...
    try:
        ...
        cursor.execute("""
            ...
            WHERE d.device_name LIKE '%BACH%MINUET%'
        ...
        if not rows:
            print("No BACH_MINUET devices found in database")
        else:
            print(f"Found {len(rows)} BACH_MINUET device records:\n")
        ...
        cursor.execute("""
            ...
            WHERE dd.device_name LIKE '%BACH%MINUET%'
        ...
        if not neighbor_rows:
            print("No neighbor connections found for BACH_MINUET devices")
        else:
            ...
            for row in neighbor_rows:
                ...
                print(f"BACH Device: {row[2]}")
                print(f"BACH Interface: {row[3]}")
