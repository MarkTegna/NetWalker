# NetWalker Build Summary v0.3.7
...
## Version History
- Previous: 0.3.5b (automatic build)
- Current: 0.3.7 (user build - letter suffix removed, PATCH incremented)

## Major Features in This Release

### 🔧 **Connection Cleanup Fixes**
This release resolves the critical connection management issues that required force termination of processes:
...
- `dist/NetWalker_v0.3.7.zip` - Complete distribution package
- `Archive/NetWalker_v0.3.7.zip` - Archive copy
...
- **ZIP Package**: `dist/NetWalker_v0.3.7.zip`
- **Archive Copy**: `Archive/NetWalker_v0.3.7.zip`
- **Repository**: https://github.com/MarkTegna (ready for push when requested)

This build successfully resolves the connection cleanup issues and provides a solid foundation for network topology discovery with enhanced reliability and robustness.